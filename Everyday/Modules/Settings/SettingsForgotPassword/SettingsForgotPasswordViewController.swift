...
final class SettingsForgotPasswordViewController: UIViewController {
...
private extension SettingsForgotPasswordViewController {
...
extension SettingsForgotPasswordViewController: ForgotPasswordViewInput {
    func showAlert(with key: String, message: String) {
    }
    
    func configure(with model: SettingsForgotPasswordViewModel) {
